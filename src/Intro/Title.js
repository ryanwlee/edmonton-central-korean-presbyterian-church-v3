import {
  churchWrapper,
  churchTitle,
  churchContentWrapper,
  churchContent,
} from './IntroCss';

const Title = () => {
  return (
    <div style={churchWrapper}>
      <div style={churchTitle}>에드몬톤 중앙 장로 교회</div>
      <div style={churchTitle}>Edmonton Korean Central Presbyterian Church</div>
      <div style={churchContentWrapper}>
        <div style={churchContent}>
